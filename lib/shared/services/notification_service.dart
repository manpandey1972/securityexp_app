...
class NotificationService {
  ...
  Future<void> showIncomingCallNotification({
    ...
    await showNotification(
      ...
      channelId: 'calls',
      groupKey: 'com.goaegent.securityexperts.CALLS',
      payload: {
        'type': 'incoming_call',
        'caller_id': callerId,
        'room_id': roomId,
  ...
  Future<void> showNewMessageNotification({
    ...
    await showNotification(
      ...
      body: message,
      channelId: 'messages',
      groupKey: 'com.goaegent.securityexperts.MESSAGES',
      payload: {
        'type': 'new_message',
        'sender_id': senderId,
        'room_id': roomId,
  ...
  Future<void> showExpertRequestNotification({
    ...
    await showNotification(
      ...
      channelId: 'general',
      groupKey: 'com.goaegent.securityexperts.EXPERT_REQUESTS',
      payload: {
        'type': 'expert_request',
    ...
    await ErrorHandler.handle<void>(
      operation: () async {
        if (!kIsWeb && Platform.isIOS) {
          ...
          const platform = MethodChannel('com.goaegent.securityexperts/notifications');
